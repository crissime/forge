...
base; deux sont a distance et quatre sont melee. Le pilote utilise deux
styles: distance et melee, soit six familles avec les trois fees.
L'utilisateur confirme que l'arme melee attaque + PV n'existe pas en divin :
elle est exclue du scenario. Aucune quantite de lignes Sante n'est imposee.
